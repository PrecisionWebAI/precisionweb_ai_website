...
const Hero = () => {
  ...
  const wordstech = [{text: "T",},{text: "E",},{text: "C",},{text: "H",},];
  ...
  return (
    <>
      ...
      <div className="w-full ">
        <div className="z-1 w-full h-[100vh] flex justify-center items-center flex-col overflow-hidden scrollbar-hide">
          ...
          <motion.h1
            ...
            className="z-1 w-full  flex justify-center items-center text-8xl font-light scrollbar-hide"
          >
            Precision Web AI
          </motion.h1>
          ...
          <div className="under-head-box flex justify-center items-center w-[50%] ">
            <div className="under-head-inner flex flex-row flex justify-between w-full">
              <div className="comprehensive-box  tracking-[0.2em] font-light">
                <TypewriterEffectSmooth words={words} />
              </div>
              <div className="  font-light">|</div>
              <div className="tech-box  tracking-[0.2em] font-light">
                <TypewriterEffectSmooth words={wordstech} />
              </div>
              <div className=" font-light">|</div>
              <div className="solution-box  tracking-[0.2em] font-light">
